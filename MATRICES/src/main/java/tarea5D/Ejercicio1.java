...
public class Ejercicio1 {
    ...
    // metodo para recibir un numero y una matriz y devuelve un array con la
    // posicion fila y columna
    ...
    public static void main(String[] args) {
        ...
        int[] coordenadas = comprobarPosicion(4, nuevaMatriz);
        System.out.println("El numero 4 esta en: Fila: " + coordenadas[0] + ", Columna: " + coordenadas[1]);
        // Mismo metodo pero retorna una lista
        List<Posicion> posiciones = comprobarPosicionList(3, nuevaMatriz);

        for (Posicion posicion : posiciones) {
            System.out.println(
                    "El numero 3 esta en: Fila: " + posicion.fila + ", Columna: " + posicion.columna);
        }
