...
public class Ficha {
    ...
    // Utiliza Color.values() para obtener el array de todos los tipos de palos
    // disponibles
    // Selecciona un color aleatorio usando r.nextInt(Color.values().length) que
    // genera un índice entre 0 y el número total de palos-1
    // Ejemplo: Si hay 4 colores, genera un número entre 0 y 3,
    // Luego asigna un número aleatorio entre 1 y 11 (inclusivo-exclusivo, por lo
    // que será entre 1 y 10)
    public Ficha() {
        this.color = color;
