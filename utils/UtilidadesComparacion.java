...
public class UtilidadesComparacion<T> {
    ...
    //Para hacer una public class Libro extends EntidadComparable, esta debe ser una clase dentro del paquete. 
...
/* 
//COMPARABLE Se puede utilizar para comparar dos objetos de una clase. Es útil cuando se necesita un orden natural para los objetos de una clase.
// * La interfaz Comparable tiene un solo método, compareTo, que toma un objeto de la misma clase y devuelve un entero.
// * Si el objeto actual es menor que el objeto pasado, devuelve un número negativo.
// * Si son iguales, devuelve 0.
// * Si el objeto actual es mayor, devuelve un número positivo.
// Requiere implementar el método compareTo en la clase. Por ejemplo, para una clase Libro:
 ...
 * 
 * //COMPARATOR Se puede utilizar para comparar dos objetos de una clase, incluso si la clase no implementa Comparable.
 * // * La interfaz Comparator tiene un solo método, compare, que toma dos objetos de la clase y devuelve un entero.
 * // * Si el primer objeto es menor que el segundo, devuelve un número negativo.
 * // * Si son iguales, devuelve 0.
 * // * Si el primer objeto es mayor, devuelve un número positivo.
 * // * Comparator es útil cuando se necesita un orden diferente al orden natural de los objetos de una clase.
 * // * Por ejemplo, si queremos ordenar libros por precio en lugar de por id, podemos usar un Comparator.
 * 
 * public class ComparadorPorPrecio implements Comparator<Libro> {
 * 
 * @Override
