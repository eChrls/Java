...
// Los campos de la tabla se mapearán con atributos de la clase
@Entity
...
// Las named queries son consultas predefinidas que se pueden reutilizar y usan el
// lenguaje JPQL (Java Persistence Query Language) que es un lenguaje de consulta
// orientado a objetos que permite realizar consultas sobre entidades en lugar de tablas
@NamedQueries({
...
public class Vehiculo implements Serializable {
    ...
    @Basic(optional = false) // Esta propiedad no puede ser null
